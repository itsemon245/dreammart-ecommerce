                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="flex-grow-1" action="{{ route('categories.store') }}"
                                                        method="post">
                                                        @csrf
                                                        <x-form.input-with-symbol name='category' label="New Category"
                                                            type='text' symbol="bx-category-alt"
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="flex-grow-1"
                                                                ...
                                                                <input type="hidden" name="id"
                                                                    value="{{ $category->id }}">
                                                                <x-form.input-with-symbol name='category'
                                                                    label="New Category" type='text'
                                    ...
                                    <div class="modal fade" id="brandModal" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="flex-grow-1"
                                                        action="{{ route('categories.brand.store') }}" method="post"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <x-form.input-with-symbol name='brand' label="New brand"
                                                            type='text' symbol="bx-git-branch"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="flex-grow-1"
                                                                ...
                                                                <x-form.input-with-symbol name='logo'
                                                                    label="brand logo" type='file'
                                                                    symbol="bx-landscape" />
