            ...
            <div class="card-body">
              <div class="text-center try">
                <strong>Using</strong>
                  ...
                  <div>
                    <a href={{route('login.social', 'google')}} class="d-flex justify-content-center align-items-center gap-2"><i style="scale:2; transition: all 250ms ease-in;" class="bx bxl-google form-text"></i>
