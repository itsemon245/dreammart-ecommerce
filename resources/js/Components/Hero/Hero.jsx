...
export default function Hero() {
    return (
        <div className="hero min-h-min lg:mt-20 sm:mt-5 z-[-1] text-white">
            <div className="hero-content py-0 flex-col sm:flex-row-reverse xl:gap-x-32 lg:gap-x-16 md:gap-x-5 gap-x-2">
                ...
                <div className=" block sm:hidden">
                    <Carousel img1='assets/carousel-img-1.png' img2='assets/carousel-img-2.png' img3='assets/carousel-img-3.png'></Carousel>
                </div>
                <div>
                    ...
                    <button className="btn sm:btn-md btn-sm capitalize 2xl:btn-lg btn-primary flex sm:gap-x-3 gap-x-1 items-center justify-center"><img className='sm:w-5 sm:h-5 h-4 w-4' src="assets/explore-icon.svg" alt="" />Explore</button>
                </div>
            </div>
        </div>
    )
