...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="card w-full bg-slate-900 shadow-xl">
      <figure><img className='w-[60%] scale-75 aspect-square object-contain' src={`/storage/${product.image}`} alt={product.name} loading='lazy' /></figure>
      <div className="card-body justify-between p-3 bg-slate-900 rounded-b-2xl">
        <ProductInfo name={product.name} price={product.price} stock={product.in_stock} category={product.category} />
